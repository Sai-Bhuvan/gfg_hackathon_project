...
export default function ExpenseList() {
  ...
  return (
    <div>
      <h2 className='flex gap-4 bg-orange-200 px-8 py-4'>
        ...
        <p className='text-3xl'>My Transactions</p>
      </h2>
      <div className='bg-orange-200 bg-opacity-30 w-3/4 mx-auto py-4 mt-4 rounded-lg'>
        <div className='grid grid-cols-6 text-gray-400 mx-auto my-4 border-b-2 border-gray-200'>
          <p className='ml-8'>Sl No.</p>
          <p>Date & Time</p>
          <p>Name</p>
          <p>Credit/Debit</p>
          <p>Amount</p>
        ...
        <div>
          {expenses.map(expense =>(
            <ExpenseCard slno={i++} expense={expense}/>
          ))}
        </div>
        </div>
    </div>
