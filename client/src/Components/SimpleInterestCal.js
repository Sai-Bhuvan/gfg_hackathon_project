...
export default function SimpleIntrestCal() {
    ...
    const calculate = () => {
        ...
        setSimpleIntrest("Simple Intrest = " + (p * t * r / 100))
    }
  return (
    <>
        <div className='body'>
            <div className="wrap">
                <div className="outer-left">
                    <div className="inner">
                        ...
                        <hr/>
                        <h2>Simple Interest<br/>Calculator</h2>
                        ...
                        <p id="result" className="text-2xl p-3">{simpleIntrest}</p>
                        <div>
