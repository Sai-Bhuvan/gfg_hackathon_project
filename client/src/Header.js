...
export default function Header() {
  ...
  useEffect(()=>{
    ...
    return (
        <>
        <header>
        <nav className=" border-orange-200 px-2 sm:px-4 py-3 bg-appOrange bg-opacity-80">
    ...
    <div className="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
      <div className="flex p-4 mt-1 border rounded-lg flex-col bg-appYellow bg-opacity-20 gap-4  lg:flex-row">
        <p>
          <a href="#" className="block py-2 pl-3 pr-4  text-gray-700 rounded hover:text-white bg-blue-700 lg:bg-transparent  lg:hover:text-blue-700 lg:text-white lg:p-0 dark:text-white" style={{fontSize: '1.1rem'}} aria-current="page">Home</a>
        </p>
        <p>
          <a href="#" className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:text-white lg:p-0 dark:text-gray-400  lg:hover:text-blue-700 hover:bg-orange-100 lg:dark:hover:text-white dark:hover:bg-orange-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-orange-700" style={{fontSize: '1.1rem'}}>About</a>
        </p>
        <p>
          <a href="#" className="block py-2 pl-3 pr-4 text-gray-700 rounded hover:text-white hover:bg-orange-100 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-orange-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-orange-700" style={{fontSize: '1.1rem'}}>Services</a>
        </p>
        <p>
